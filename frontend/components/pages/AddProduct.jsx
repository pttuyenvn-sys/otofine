...
export default function AddProductPopup({ onClose, onSuccess }) {
  ...
  // ✅ chỉ riêng lỗi trùng mã
  if (message === "Mã sản phẩm đã tồn tại") {
    alert(message);
  } else {
  ...
  return (
    <div className="PopupOverlay">
      <div className="PopupForm" style={{ maxWidth: 900 }}>
        <h2>Thêm sản phẩm</h2>
